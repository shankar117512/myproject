...
def load_embed_wheel(
    app_data: AppData, distribution: str, for_py_version: str, version: str | None
) -> Wheel | None:
    ...
    if wheel is not None:
        ...
        if version is None or version_match:
            ...
            ) as wheel_path:  # ty: ignore[invalid-argument-type]
...
def from_dir(
    distribution: str, version: str | None, for_py_version: str, directories: list[Path]
) -> Wheel | None:
