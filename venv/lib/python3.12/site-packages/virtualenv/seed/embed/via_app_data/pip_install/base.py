...
class PipInstall(ABC):
    ...
    def install(self, version_info: tuple[int, ...]) -> None:
        ...
        for (
            name,
            module,
        ) in self._console_scripts.items():  # ty: ignore[unresolved-attribute]
            consoles.update(
    ...
    def _generate_new_files(self) -> set[Path]:
        ...
        marker = (
            self._image_dir / f"{self._dist_info.stem}.virtualenv"
    ...
    def _console_scripts(self) -> dict[str, str] | None:
        ...
        if self._console_entry_points is None:
            ...
            entry_points = (
                self._dist_info / "entry_points.txt"
    ...
    def _uninstall_previous_version(self) -> None:
        dist_name = self._dist_info.stem.split("-")[
            0
        ]  # ty: ignore[unresolved-attribute]
