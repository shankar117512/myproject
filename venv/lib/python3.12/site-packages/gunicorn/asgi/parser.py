    ...
    def _parse_headers(self):
        ...
        while True:
            ...
            if (
                ...
                and len(line) + 2 > self._limit_request_field_size
            ):
            ...
            if name == b"content-length":
                ...
                for val in vals:
                    ...
                    if val_lower == b"chunked":
                        ...
                        if chunked:
                            raise InvalidHeader(
                                "Invalid Transfer-Encoding after chunked"
                            )
...
class CallbackRequest:
    ...
    def from_parser(cls, parser, is_ssl=False):
        ...
        req.headers_bytes = list(
            getattr(parser, "asgi_headers", None) or parser.headers
        )
        req.headers = [
